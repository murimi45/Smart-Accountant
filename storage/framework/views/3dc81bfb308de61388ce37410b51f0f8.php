    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e(count($streams)); ?> Streams</span>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table grade-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="row-number">#<?php echo e($stream->id); ?></span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="grade-icon">
                                        <?php echo e(strtoupper(substr($stream->class->name ?? 'N/A', 0, 1))); ?>

                                    </div>
                                    <div class="ms-3">
                                        <div class="grade-name"><?php echo e($stream->class->name ?? 'N/A'); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="stream-name"><?php echo e($stream->name); ?></span>
                            </td>
                            <td>
                                <div class="action-buttons">
                                    <button 
                                        class="btn btn-sm btn-light editStreamBtn"
                                        data-id="<?php echo e($stream->id); ?>"
                                        data-grade-id="<?php echo e($stream->grade_id); ?>"
                                        data-name="<?php echo e($stream->name); ?>"
                                        title="Edit Stream">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <form action="<?php echo e(route('streams.destroy', $stream->id)); ?>" 
                                          method="POST" 
                                          class="d-inline"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('editStreamForm').action = `<?php echo e(url('streams')); ?>/${id}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/streams/index.blade.php ENDPATH**/ ?>