                    ...
                    <div class="login-wrapper">
                        <div class="login_section">
                                ...
                                <div class="recovery-codes-grid" id="recovery-codes">
                                    <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="recovery-code-item">
                                            <span class="code-number"><?php echo e($index + 1); ?></span>
                                            <span class="code-value"><?php echo e($code); ?></span>
                                        </div>
                            ...
                            <div class="field mb-3">
                                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-success w-100 submit-btn">
...
.form-side {
    ...
    <script>
        const codes = <?php echo json_encode($codes, 15, 512) ?>;

        // Download codes as text file
        function downloadCodes() {
            const content = 'Two-Factor Authentication Recovery Codes\n' +
                           'Generated: ' + new Date().toLocaleString() + '\n' +
                           'Account: <?php echo e(auth()->user()->email); ?>\n\n' +
        ...
        function printCodes() {
            const printContent = `
                ...
                <body>
                    ...
                    <p><strong>Account:</strong> <?php echo e(auth()->user()->email); ?></p>
...
</body><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/twofactor/recovery.blade.php ENDPATH**/ ?>