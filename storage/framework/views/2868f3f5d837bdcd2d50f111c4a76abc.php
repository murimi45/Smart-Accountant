    ...
    <div class="page_title">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('termlist')); ?>" class="btn btn-outline-secondary px-4 py-2 fw-bold">
        ...
        <div class="col-12">
            <div class="white_shd full margin_bottom_30" style="border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid #f0f0f0;">
                ...
                <div class="padding_infor_info" style="padding: 35px 30px;">
                    <form action="<?php echo e(route('editterm', $term->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date"
                                           id="start_date"
                                           name="start_date"
                                           value="<?php echo e(old('start_date', $term->start_date ? \Illuminate\Support\Carbon::parse($term->start_date)->format('Y-m-d') : '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date"
                                           id="end_date"
                                           name="end_date"
                                           value="<?php echo e(old('end_date', $term->end_date ? \Illuminate\Support\Carbon::parse($term->end_date)->format('Y-m-d') : '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input"
                                       ...
                                       name="active"
                                       value="1"
                                       <?php echo e(old('active', $term->active) ? 'checked' : ''); ?>>
                        ...
                        <div class="form-actions mt-5 pt-4 text-center" style="border-top: 1px solid #e8eaed;">
                            ...
                            <a href="<?php echo e(route('termlist')); ?>" class="btn btn-outline-secondary px-5 py-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/term/edit.blade.php ENDPATH**/ ?>