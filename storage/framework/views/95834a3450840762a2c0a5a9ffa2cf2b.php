    ...
    <div class="page_title">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('assignextrafee')); ?>" class="btn btn-success px-4 py-2 fw-bold shadow-sm">
        ...
        <div class="col-12">
            <div class="white_shd full margin_bottom_30" style="border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid #f0f0f0;">
                ...
                <div class="full inner_elements" style="padding: 25px;">
                    <form method="GET" action="<?php echo e(route('listextrafeestudents')); ?>" class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('listextrafeestudents')); ?>" class="btn btn-secondary flex-fill" style="border-radius: 8px;">
                ...
                <div class="card-header">
                    <h5>
                        ...
                        <span class="badge bg-primary ms-2" style="font-size: 12px; padding: 6px 12px; border-radius: 20px;">
                            <?php echo e(count($extraFeeStudents)); ?> Total
                        </span>
                    </h5>
                </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <strong><?php echo e($extraFeeStudent->extraFee->name); ?></strong>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td>
                                        <span class="badge" style="background: linear-gradient(135deg, #79c347 0%, #5fa732 100%); color: white; padding: 8px 14px; border-radius: 6px; font-weight: 600; font-size: 13px;">
                                            <i class="fa fa-coins me-1"></i>KSh <?php echo e(number_format($extraFeeStudent->amount, 2)); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge" style="background: #e3f2fd; color: #1976d2; padding: 6px 12px; border-radius: 6px; font-weight: 600;">
                                            <?php echo e($extraFeeStudent->quantity); ?>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span style="font-size: 13px; color: #495057;"><?php echo e($extraFeeStudent->creator->admin_name); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-2">
