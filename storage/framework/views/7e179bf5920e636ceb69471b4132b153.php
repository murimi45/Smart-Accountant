                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($category->description): ?>
                                        <span class="description-text"><?php echo e(Str::limit($category->description, 50)); ?></span>
                                    <?php else: ?>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <form action="<?php echo e(route('expense_categories.destroy', $category->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?php echo e(route('expense_categories.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="editCategoryModal<?php echo e($category->id); ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?php echo e(route('expense_categories.update', $category->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="edit_name_<?php echo e($category->id); ?>" class="form-label">
                            Category Name <span class="text-danger">*</span>
                        </label>
                        <input type="text" 
                               id="edit_name_<?php echo e($category->id); ?>"
                               name="name" 
                               class="form-control" 
                    ...
                    <div class="mb-0">
                        <label for="edit_description_<?php echo e($category->id); ?>" class="form-label">
                            Description
                        </label>
                        <textarea id="edit_description_<?php echo e($category->id); ?>"
                                  name="description" 
                                  class="form-control" 
                                  rows="4"><?php echo e($category->description); ?></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/expenses/categories.blade.php ENDPATH**/ ?>