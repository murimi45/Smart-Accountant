                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="<?php echo e(url('/deleteClass/' . $value->id)); ?>" 
...
<div class="modal fade" id="addClassModal" tabindex="-1" aria-labelledby="addClassModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <form id="addClassForm" action="<?php echo e(url('/insertClass')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
    ...
    if (editButtons.length) {
        editButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (editForm) {
                    editForm.action = '<?php echo e(url("/editClass")); ?>/' + id;
                }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/class/list.blade.php ENDPATH**/ ?>