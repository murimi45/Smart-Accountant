                    ...
                    <div class="description-content">
                        ...
                        <div class="benefits-list">
                            ...
                            <div class="benefit-item">
                                ...
                                <span>Find the 6-digit code for <?php echo e(config('app.name')); ?></span>
                            </div>
                            <div class="benefit-item">
                    ...
                    <div class="login-wrapper">
                        <div class="login_section">
                            ...
                            <div class="user-info-box mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="user-details">
                                        <div class="user-name"><?php echo e(auth()->user()->admin_name); ?></div>
                            ...
                            <div class="login_form">
                                <form method="POST" action="<?php echo e(route('twofactor.challenge.verify')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <fieldset>
...
</body><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/twofactor/challenge.blade.php ENDPATH**/ ?>