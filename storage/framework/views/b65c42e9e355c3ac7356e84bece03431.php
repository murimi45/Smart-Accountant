...
<div class="main-wrapper">
    ...
    <div class="card filter-card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admins.index')); ?>" class="filter-form">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('admins.index')); ?>" class="btn btn-outline-secondary" title="Reset">
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e($admins->total()); ?> Users</span>
            </div>
        </div>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="admin-avatar">
                                        <?php echo e(strtoupper(substr($admin->admin_name, 0, 1))); ?>

                                    </div>
                                    <div class="ms-3">
                                        <div class="admin-name"><?php echo e($admin->admin_name); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/admins/index.blade.php ENDPATH**/ ?>