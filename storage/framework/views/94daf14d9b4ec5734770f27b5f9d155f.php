...
<div class="main-wrapper">
    ...
    <div class="page_title">
        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                <h4 class="mb-0">Edit Class Fee</h4>
                <p class="text-muted mb-0 mt-1">Update fee structure information</p>
            </div>
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('classfeelist')); ?>" class="btn btn-secondary px-4 py-2">
            ...
            <div class="white_shd full margin_bottom_30" style="border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid #f0f0f0;">
                <div class="full graph_head" style="background: linear-gradient(135deg, #36a9e2 0%, #1e88c7 100%); padding: 25px 30px; border-radius: 12px 12px 0 0;">
                    <div class="heading1 margin_0">
                        ...
                        <p class="mb-0 mt-2" style="color: rgba(255,255,255,0.9); font-size: 14px;">Update the details below to modify the fee structure</p>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($class->id); ?>" <?php echo e(old('class_id', $classfee->class_id) == $class->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($term->id); ?>" <?php echo e(old('term_id', $classfee->term_id) == $term->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-section mb-4">
                            <h5 class="section-title mb-4" style="color: #2c3e50; font-weight: 600; font-size: 16px; display: flex; align-items: center; padding-bottom: 12px; border-bottom: 2px solid #e8eaed;">
                                <i class="fa fa-dollar-sign me-2" style="color: #36a9e2;"></i>
                                Fee Details
                            </h5>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group" style="border-radius: 8px;">
                                        ...
                                        <input type="number" 
                                               id="amount" 
                                               name="amount" 
                                               value="<?php echo e(old('amount', $classfee->amount)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="active" <?php echo e(old('status', $classfee->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                                        <option value="inactive" <?php echo e(old('status', $classfee->status) == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              style="border-radius: 8px; border: 1px solid #e0e0e0; padding: 12px 16px; font-size: 14px;"
                                              required><?php echo e(old('description', $classfee->description)); ?></textarea>
                        ...
                        <div class="form-actions mt-5 pt-4" style="border-top: 1px solid #e8eaed;">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-primary px-5 py-3 me-3" style="border-radius: 8px; font-weight: 600; font-size: 15px; min-width: 180px;">
                                        <i class="fa fa-check-circle me-2"></i>Update Fee
                                    </button>
                                    <a href="<?php echo e(route('classfeelist')); ?>" class="btn btn-outline-secondary px-5 py-3" style="border-radius: 8px; font-weight: 600; font-size: 15px; min-width: 180px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/classfee/edit.blade.php ENDPATH**/ ?>