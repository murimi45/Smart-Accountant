            ...
            <form method="GET" action="<?php echo e(route('listStudents')); ?>" class="filter-form">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="admission" class="form-control" placeholder="Enter admission" value="<?php echo e(request('admission')); ?>">
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('listStudents')); ?>" class="btn btn-outline-secondary" title="Reset">
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fa fa-users me-2"></i>Student List
                </h5>
                <span class="badge bg-light text-dark"><?php echo e($getRecord->total()); ?> Students</span>
            </div>
        </div>
