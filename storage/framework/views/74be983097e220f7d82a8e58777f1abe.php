        ...
        <div class="card-body py-3">
            <div class="d-flex align-items-center gap-4 flex-wrap" style="font-size:13px;">
                <span>
                    ...
                    <strong><?php echo e($run->type === 'term_promotion' ? 'Term promotion' : 'Year promotion'); ?></strong>
                </span>
                <span>
                    <span class="text-muted">From:</span>
                    <strong><?php echo e($run->fromTerm ? $run->fromTerm->name . ' — ' . $run->fromTerm->year : '—'); ?></strong>
                </span>
                <span>
                    <span class="text-muted">To:</span>
                    <strong><?php echo e($run->toTerm ? $run->toTerm->name . ' — ' . $run->toTerm->year : '—'); ?></strong>
                </span>
                <span>
                    <span class="text-muted">Initiated by:</span>
                    <strong><?php echo e($run->promotedBy ? $run->promotedBy->name : 'System'); ?></strong>
                </span>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="batch-list" id="batch-list">
                        ...
                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="batch-row batch-wait" id="batch-<?php echo e($class->id); ?>">
                                <span class="batch-dot dot-wait"></span>
                                <span class="batch-name">
                                    <?php echo e($class->name); ?>

                                    <?php if($class->is_final): ?> — Final year <?php endif; ?>
                                </span>
...
const pollUrl  = '<?php echo e(route("promotion.poll", $run->id)); ?>';
const enrollmentUrl = '<?php echo e(route("enrollment.index")); ?>';
const invoicesUrl   = '<?php echo e(route("invoices.index")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/promotion/promotionprogress.blade.php ENDPATH**/ ?>