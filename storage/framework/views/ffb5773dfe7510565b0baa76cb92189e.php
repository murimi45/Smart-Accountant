    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e(count($years)); ?> Years</span>
            </div>
        </div>
                ...
                <table class="table term-table mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <span class="row-number">#<?php echo e($year->id); ?></span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="term-icon">
                                            <?php echo e(strtoupper(substr($year->name, 0, 1))); ?>

                                        </div>
                                        <div class="ms-3">
                                            <div class="term-name"><?php echo e($year->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button 
                                            ...
                                            data-current="<?php echo e($year->is_current ? '1' : '0'); ?>"
                                            title="Edit Academic Year">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <form action="<?php echo e(route('academic-years.destroy', $year->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this year?');">
                                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addYearModal" tabindex="-1" aria-labelledby="addYearModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="addYearForm" action="<?php echo e(route('academic-years.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            // Set form action
            document.getElementById('editYearForm').action = `<?php echo e(url('academic-years')); ?>/${id}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/academic_years/index.blade.php ENDPATH**/ ?>