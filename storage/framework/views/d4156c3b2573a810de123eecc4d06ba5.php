    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('addterm')); ?>" class="btn btn-success">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                    value="<?php echo e($currentTerm->name); ?>" 
                                    class="form-control" 
                                    readonly>
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <div class="term-name"><?php echo e($value->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="date-text">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($value->start_date)->format('d M, Y')); ?>
                                ...
                                <td>
                                    <?php if($value->end_date): ?>
                                        <span class="date-text">
                                            ...
                                            <?php echo e(\Carbon\Carbon::parse($value->end_date)->format('d M, Y')); ?>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="<?php echo e(url('/editterm/' . $value->id)); ?>" 
                                           class="btn btn-sm btn-light" 
                                           title="Edit Term">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="<?php echo e(url('/deleteterm/' . $value->id)); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/term/list.blade.php ENDPATH**/ ?>