                ...
                <div class="col-lg-6 description-side d-none d-lg-block">
                    <div class="description-content">
                        ...
                        <div class="security-badge mt-5">
                            ...
                            <span>Required for <?php echo e(auth()->user()->role); ?> accounts</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="login-wrapper">
                        <div class="login_section">
                            ...
                            <div class="login_form">
                                <form method="POST" action="<?php echo e(route('twofactor.confirm')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <fieldset>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="text-center mt-4">
                                <p class="footer-text mb-2">
                                    Logged in as <strong><?php echo e(auth()->user()->email); ?></strong>
                                </p>
...
@media (max-width: 576px) {
    ...
    <script>
        ...
        function copySecret() {
            const secret = '<?php echo e($secret); ?>';
...
</body><?php /**PATH C:\Users\Allan\smart_accountant2\resources\views/twofactor/setup.blade.php ENDPATH**/ ?>