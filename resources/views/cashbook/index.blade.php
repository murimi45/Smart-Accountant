            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <div class="balance-card">
                    ...
                    <div class="balance-content">
                        ...
                        <div class="balance-value">KSh {{ number_format($balance, 2) }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">{{ $entries->total() }} Entries</span>
            </div>
        </div>
                ...
                <table class="table cashbook-table mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="transaction-icon {{ $entry->transaction_type === 'inflow' ? 'transaction-inflow' : 'transaction-outflow' }}">
                                ...
                                <td>
                                    <span class="badge-method">{{ ucfirst($entry->payment_method) }}</span>
                                </td>
                                <td class="text-end">
                    ...
                    <tfoot>
                        <tr class="totals-row">
                            ...
                            <td class="text-end">
                                <span class="total-inflow">KSh {{ number_format($totalInflow, 2) }}</span>
                            </td>
                            <td class="text-end">
                                <span class="total-outflow">KSh {{ number_format($totalOutflow, 2) }}</span>
                            </td>
                        </tr>
                        <tr class="balance-row">
                            ...
                            <td colspan="2" class="text-end">
                                <span class="closing-balance">KSh {{ number_format($totalInflow - $totalOutflow, 2) }}</span>
                            </td>
                        </tr>
                    </tfoot>
                    @endif
