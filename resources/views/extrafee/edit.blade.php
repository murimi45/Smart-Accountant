...
<div class="main-wrapper">
    ...
    <div class="page_title">
        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                <h4 class="mb-0">Edit Extra Fee</h4>
                <p class="text-muted mb-0 mt-1">Update extra fee category information</p>
            </div>
            ...
            <div class="white_shd full margin_bottom_30" style="border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid #f0f0f0;">
                <div class="full graph_head" style="background: linear-gradient(135deg, #36a9e2 0%, #1e88c7 100%); padding: 25px 30px; border-radius: 12px 12px 0 0;">
                    <div class="heading1 margin_0">
                        ...
                        <p class="mb-0 mt-2" style="color: rgba(255,255,255,0.9); font-size: 14px;">Update the details below to modify the extra fee category</p>
                    </div>
                </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-section mb-4">
                            <h5 class="section-title mb-4" style="color: #2c3e50; font-weight: 600; font-size: 16px; display: flex; align-items: center; padding-bottom: 12px; border-bottom: 2px solid #e8eaed;">
                                <i class="fa fa-info-circle me-2" style="color: #36a9e2;"></i>
                                Basic Information
                            </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group" style="border-radius: 8px;">
                                        ...
                                        <input type="number" 
                                               id="amount" 
                                               name="amount" 
                                               value="{{ old('amount', $extrafee->amount) }}" 
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select id="is_quantity_based" 
                                        ...
                                        <option value="0" {{ old('is_quantity_based', $extrafee->is_quantity_based) == '0' ? 'selected' : '' }}>No (Fixed Amount)</option>
                                        <option value="1" {{ old('is_quantity_based', $extrafee->is_quantity_based) == '1' ? 'selected' : '' }}>Yes (Multiply by Quantity)</option>
                                    </select>
                        ...
                        <div class="form-section mb-4">
                            <h5 class="section-title mb-4" style="color: #2c3e50; font-weight: 600; font-size: 16px; display: flex; align-items: center; padding-bottom: 12px; border-bottom: 2px solid #e8eaed;">
                                <i class="fa fa-calendar me-2" style="color: #36a9e2;"></i>
                                Academic Period
                            </h5>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <select id="term_id" 
                                        ...
                                        @foreach($terms as $term)
                                            <option value="{{ $term->id }}" {{ old('term_id', $extrafee->term_id) == $term->id ? 'selected' : '' }}>
                                                {{ $term->name }} - {{ $term->year }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-section mb-4">
                            <h5 class="section-title mb-4" style="color: #2c3e50; font-weight: 600; font-size: 16px; display: flex; align-items: center; padding-bottom: 12px; border-bottom: 2px solid #e8eaed;">
                                <i class="fa fa-file-alt me-2" style="color: #36a9e2;"></i>
                                Additional Details
                            </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea id="description" 
                                              ...
                                              style="border-radius: 8px; border: 1px solid #e0e0e0; padding: 12px 16px; font-size: 14px;"
                                              required>{{ old('description', $extrafee->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-primary px-5 py-3 me-3" style="border-radius: 8px; font-weight: 600; font-size: 15px; min-width: 180px;">
                                        <i class="fa fa-check-circle me-2"></i>Update Extra Fee
                                    </button>
