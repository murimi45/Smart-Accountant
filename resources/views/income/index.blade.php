...
<div class="main-wrapper">
    ...
    <div class="row mb-4">
        <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
            <div class="summary-card">
                ...
                <div class="summary-content">
                    <div class="summary-value">KSh {{ number_format($incomes->sum('amount'), 2) }}</div>
        ...
        <div class="col-lg-3 col-md-6 mb-3 mb-md-0">
            <div class="summary-card">
                ...
                <div class="summary-content">
                    <div class="summary-value">KSh {{ number_format($incomes->where('income_date', '>=', now()->startOfMonth())->sum('amount'), 2) }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="summary-card">
                ...
                <div class="summary-content">
                    <div class="summary-value">{{ $incomes->groupBy('income_category_id')->count() }}</div>
    ...
    <div class="card filter-card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('other_incomes.index') }}" class="filter-form">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('other_incomes.index') }}" class="btn btn-outline-secondary" title="Reset">
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">{{ $incomes->count() }} Entries</span>
            </div>
        </div>
                ...
                <table class="table income-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="category-icon">
                                        {{ strtoupper(substr($income->category->name ?? 'N', 0, 1)) }}
                                    </div>
                                    <div class="ms-3">
                                        <div class="category-name">{{ $income->category->name ?? 'N/A' }}</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="badge-method">{{ ucfirst($income->payment_method ?? '-') }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                @if($income->description)
                                    <span class="description-text">{{ Str::limit($income->description, 50) }}</span>
                                @else
