            ...
            <form method="GET" action="{{ route('listStudents') }}" class="filter-form">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="admission" class="form-control" placeholder="Enter admission" value="{{ request('admission') }}">
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('listStudents') }}" class="btn btn-outline-secondary" title="Reset">
    ...
    <div class="card table-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">{{ $getRecord->total() }} Students</span>
            </div>
        </div>
