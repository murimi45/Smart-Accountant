                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select id="class_id" 
                                        ...
                                        @foreach($classes as $class)
                                            <option value="{{ $class->id }}" {{ old('class_id', $classfee->class_id) == $class->id ? 'selected' : '' }}>
                                                {{ $class->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select id="term_id" 
                                        ...
                                        @foreach($terms as $term)
                                            <option value="{{ $term->id }}" {{ old('term_id', $classfee->term_id) == $term->id ? 'selected' : '' }}>
                                                {{ $term->name }} - {{ $term->year }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group" style="border-radius: 8px;">
                                        ...
                                        <input type="number" 
                                               id="amount" 
                                               name="amount" 
                                               value="{{ old('amount', $classfee->amount) }}" 
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select id="status" 
                                        ...
                                        <option value="active" {{ old('status', $classfee->status) == 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="inactive" {{ old('status', $classfee->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea id="description" 
                                              ...
                                              style="border-radius: 8px; border: 1px solid #e0e0e0; padding: 12px 16px; font-size: 14px;"
                                              required>{{ old('description', $classfee->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
